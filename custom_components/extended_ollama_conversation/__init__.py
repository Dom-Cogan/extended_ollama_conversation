...
class OllamaAIAgent(conversation.AbstractConversationAgent):
    """ollamaAI conversation agent."""
    ...
    async def query(
        ...
        choice: OllamaChoice = response.choices[0]
